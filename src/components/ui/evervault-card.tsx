	...
	return (
		...
		>
			<div
				...
				role="img"
				aria-label={text || "Evervault card"}
			>
				<CardPattern
					mouseX={mouseX}
					mouseY={mouseY}
	...
	return (
		<div className="pointer-events-none">
			...
			<motion.div
				...
				style={style}
			>
				<p className="absolute inset-x-0 text-xs h-full break-word whitespace-pre-wrap text-white font-mono font-bold transition duration-500">
					{randomString}
				</p>
			</motion.div>
		</div>
